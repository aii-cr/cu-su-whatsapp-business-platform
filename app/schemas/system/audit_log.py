...
class AuditLogCreate(BaseModel):
    ...
    actor_type: str = Field("user", pattern="^(user|system|api|webhook)$", description="Type of actor")
...
class AuditLogExportRequest(BaseModel):
    ...
    actor_ids: Optional[List[PyObjectId]] = Field(None, description="Export logs for specific actors")
...
class AuditConfiguration(BaseModel):
    ...
    log_levels: List[str] = Field(default=["info", "warning", "error", "critical"], description="Enabled log levels")
